...
export type HookInteractionRequestMessage = HookEnvelope<'interaction.request', InteractionRequestPayload>;
export type HookInteractionDecisionMessage = HookEnvelope<'interaction.decision', InteractionDecisionPayload>;
export type HookInteractionCancelMessage = HookEnvelope<'interaction.cancel', InteractionCancelPayload>;
